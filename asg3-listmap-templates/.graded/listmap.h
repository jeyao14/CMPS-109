// $Id: listmap.h,v 1.3 2019-11-12 03:42:07-08 - - $
// Jeffrey Yao jeyao
// Herman Wu hwwu
...
class listmap {
   ...
   public:
      ...
      bool empty() const { return anchor_.next == 
         &anchor_; }
};
...
class listmap<key_t,mapped_t,less_t>::iterator {
   ...
   public:
      ...
      key_t get_key () { return where->value.first; }
      mapped_t get_value () { return where->value.second; }
};
